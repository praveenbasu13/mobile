...
<body class="padTop53 ">
    ...
    <div id="wrap">
       ...
       <div id="left" >
		...
		<?php   
					...
					?>
		<a id="example6" href="assets/img/Product_Uploaded/<?php echo $product['flaturedimage'];?>" title="Name: <?php echo $product['product_name'];?> | Brand: <?php echo $product['brand'];?> | Stock: <?php echo $product['quantity'];?> " ><img src="assets/img/Product_Uploaded/<?php echo $product['flaturedimage'];?>" alt="" / style="width:200px; height:200px"; ></a>
	...
	<?php } ?>
		...
		<?php   
					...
					?>
		<a id="example6" href="assets/img/Profile_Uploaded/<?php echo $product['profilepicture'];?>" title="Name: <?php echo $product['name'];?> | Role: <?php echo $product['role'];?> " ><img src="assets/img/Profile_Uploaded/<?php echo $product['profilepicture'];?>" alt="" / style="width:200px; height:200px"; ></a>
